...
/**
 * Event fired when an AI account attempts to view its API token.
...
public class GetTokenEvent extends Event implements Cancellable {
     ...
     *
     * @param account      The account attempting to view the token.
     * @param platformName The name of the platform, or null if viewing the active session's token.
     */
    public GetTokenEvent(AIAccount account, String platformName) {
        super(true);
